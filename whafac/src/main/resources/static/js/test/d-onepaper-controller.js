...
function paperInit() {
  ...
  for (let i = 0; i < db.length; i++) {
    ...
    $combo.append('<option ' + sel + ' value="' + db[i]['product'] + '" data-thick="' + db[i]['thick'] + '" data-gram="' + gram + '" data-max="' + db[i]['max'] + '" data-nuvera="' + db[i]['is_nuvera'] + '" data-obj="' + obj1 + '" data-toner="' + obj2 + '" data-indigo="' + obj3 + '" data-dc="' + db[i]['is_dc'] + '" data-istoner="' + is_toner + '" data-isindigo="' + is_indigo + '">' + db[i]['gram'] + '</option>\n');
  }
}
